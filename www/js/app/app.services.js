angular.module('pharm_mobapp.app.services', [])

    .service('AuthService', function() {

        this.saveUser = function(user) {
            window.localStorage.pharm_mobapp_user = JSON.stringify(user);
        };

        this.getLoggedUser = function() {

            return (window.localStorage.pharm_mobapp) ?
                JSON.parse(window.localStorage.pharm_mobapp) : null;
        };
